...
onMounted(() => {
  ...
  function initSideMenu() {
    ...
    var closeTargets = document.querySelectorAll('[data-menu-close]')
    ...
    <main class="phone-shell">
      <div class="phone-scroll">
        ...
        <section class="content">
          <div class="top-cards">
            <a class="info-card" href="./group-list.html">
          ...
          <div class="drawer-content">
            <section class="drawer-section" aria-labelledby="drawer-common-title">
              ...
              <nav class="drawer-list" aria-label="常用功能">
                <a class="drawer-link" href="./group-list.html">
...
.phone-shell {
  ...
  border-radius: 23px;
  overflow: hidden;
  box-shadow: 0 20px 60px rgba(71, 82, 163, 0.18);
  position: relative;
  display: flex;
