(function () {
  var DRAWER_HTML = [
    ...
    '          <a class="drawer-link is-pending" href="./signup.html" aria-disabled="true" tabindex="-1"><span class="drawer-icon"><img src="./images/ball.png" alt=""></span><span>季打報名</span></a>',
    '          <a class="drawer-link is-pending" href="./active-activity.html" aria-disabled="true" tabindex="-1"><span class="drawer-icon"><img src="./images/icon-album.png" alt=""></span><span>參與紀錄</span></a>',
    '        </nav>',
    '      </section>',
    '    </div>',
